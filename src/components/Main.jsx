  ...
  return (
    <div >
      <form onSubmit={handleSubmit}>
        <img src="/bankster.png" alt='bankster' />
        <h1>Bankster India Resume Generator</h1>
        ...
        <TextField id="outlined-basic" variant="outlined" fullWidth className="textfield"        label="Email Id"   value={emailId}  onChange={(event) => {
            setEmailId(event.target.value);}}/>
        <TextField id="outlined-basic" variant="outlined" fullWidth className="textfield"        label="Age"   value={age}  onChange={(event) => {
            setAge(event.target.value);}}/>
        <TextField id="outlined-basic" variant="outlined" fullWidth className="textfield"        label="Highest Qualification"   value={highestQualification}  onChange={(event) => {
            setHighestQualification(event.target.value);}}/>
        <TextField id="outlined-basic" variant="outlined"  fullWidth className="textfield"       label="Current Location"   value={currentLocation}  onChange={(event) => {
            setCurrentLocation(event.target.value);}}/>
        <TextField id="outlined-basic" variant="outlined" fullWidth className="textfield"        label="Current Company"   value={currentCompany}  onChange={(event) => {
            setCurrentCompany(event.target.value);}}/>
        <TextField id="outlined-basic" variant="outlined" fullWidth className="textfield"        label="Current Designation"   value={currentDesignation}  onChange={(event) => {
            setCurrentDesignation(event.target.value);}}/>
        <TextField id="outlined-basic" variant="outlined" fullWidth className="textfield"        label="Current Product"   value={currentProduct}  onChange={(event) => {
            setCurrentProduct(event.target.value);}}/>
        <TextField id="outlined-basic" variant="outlined" fullWidth className="textfield"        label="Avg Ticket Size"   value={avgTicketSize}  onChange={(event) => {
            setAvgTicketSize(event.target.value);}}/>
        <TextField id="outlined-basic" variant="outlined" fullWidth className="textfield"        label="ROI"    value={roi} onChange={(event) => {
            setRoi(event.target.value);}}/>
        <TextField id="outlined-basic" variant="outlined"  fullWidth className="textfield"       label="Average Buisness / Portfolio"  value={averageBuisness}   onChange={(event) => {
            setAverageBuisness(event.target.value);}}/>
        <TextField id="outlined-basic" variant="outlined" fullWidth className="textfield"        label="No Of Team Members"  value={naoOfTeamMembers}   onChange={(event) => {
            setNaoOfTeamMembers(event.target.value);}}/>
        <TextField id="outlined-basic" variant="outlined" fullWidth className="textfield"        label="No. of DSA"  value={noofDSA}   onChange={(event) => {
            setNoofDSA(event.target.value);}}/>
        <TextField id="outlined-basic" variant="outlined" fullWidth className="textfield"        label="Total Years of Exp"  value={totalYearsofExp}   onChange={(event) => {
            setTotalYearsofExp(event.target.value);}}/>
        <TextField id="outlined-basic" variant="outlined"  fullWidth className="textfield"       label="Relevant Years of Exp"  value={relevantYearsofExp}   onChange={(event) => {
            setRelevantYearsofExp(event.target.value);}}/>
        <TextField id="outlined-basic" variant="outlined"  fullWidth className="textfield"       label="Current CTC"  value={currentCTC}   onChange={(event) => {
            setCurrentCTC(event.target.value);}}/>
            <TextField id="outlined-basic" variant="outlined"  fullWidth className="textfield"       label="Expected CTC "  value={expectedCTC}   onChange={(event) => {
            setExpectedCTC(event.target.value);}}/>
            <TextField id="outlined-basic" variant="outlined"  fullWidth className="textfield"       label="Notice Period"  value={noticePeriod}   onChange={(event) => {
            setNoticePeriod(event.target.value);}}/>
            <TextField id="outlined-basic" variant="outlined"  fullWidth className="textfield"       label="Reason For Change"  value={reasonforChange}   onChange={(event) => {
            setReasonforChange(event.target.value);}}/>
             <TextField id="outlined-basic" variant="outlined"  fullWidth className="textfield"       label="Remarks "  value={remarks}   onChange={(event) => {
            setRemarks(event.target.value);}}/>
  

          <h2>Generate Key Value Pair Data (optional): </h2>
        <TextField
        fullWidth
        className="textfield" 
          id="outlined-basic"
      ...
      <tbody>
        {
          ...
          <td data-label="Age">{item.lastName}</td>
          <td data-label="Job" style={{textAlign:"center"}}>
            <IconButton
            onClick={() => {
              setMessage(
